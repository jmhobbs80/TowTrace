...
/**
 * New Inspection Form
 * Form to create a new vehicle inspection
 */
export default function NewInspection() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // If we have a vehicleId from query params, set it in form
        if (vehicleId) {
          setFormData(prev => ({
            ...prev,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Submit to API
      const response = await InspectionsAPI.createInspection(formData);
      
      // Redirect to the new inspection detail page
      router.push(`/dashboard/inspections/${response.data.id}`);
  ...
  return (
    <>
      <Head>
        <title>New Inspection | TowTrace</title>
        <meta name="description" content="Create a new vehicle inspection" />
      </Head>

      <DashboardLayout title="Create New Inspection">
        {/* Back button */}
        <div className="mb-6">
                ...
                <div className="grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      Select the vehicle to be inspected
                    </p>
                  </div>
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      Select the driver performing the inspection
                    </p>
                  </div>
                  ...
                  <div className="sm:col-span-3">
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      Default is "Pending" for new inspections
                    </p>
                  </div>
                  ...
                  <div className="sm:col-span-6">
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      Enter any notes or observations about the vehicle condition
                    </p>
                  </div>
